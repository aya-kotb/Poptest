...
/// <summary>
/// Based on the UnityUIDialogueControls class of the "Dialogue System for Unity" plugin
/// Just commented out the HidePanel() method inside the overriden SetActive method
/// Contains all dialogue (conversation) controls for a Unity UI Dialogue UI.
/// </summary>
[System.Serializable]
public class CustomUIDialogControls : AbstractDialogueUIControls {
