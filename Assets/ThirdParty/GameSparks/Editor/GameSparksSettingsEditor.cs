...
namespace GameSparks.Editor
{
    ...
    public class GameSparksSettingsEditor : UnityEditor.Editor
    {
    	...
    	const string UnityAssetFolder = "Assets/ThirdParty";
    	...
    	public override void OnInspectorGUI()
    	{
    		...
    		String testScenePath = "Assets/ThirdParty/GameSparks/TestUI/GameSparksTestUI.unity";
    		...
    		if(GameSparksSettings.ApiKey != null && GameSparksSettings.ApiSecret != null){
    			String myApiPath = "Assets/ThirdParty/GameSparks/MyGameSparks.cs";
