...
namespace PixelCrushers.DialogueSystem
{
    ...
    public class Selector : MonoBehaviour
    {
        ...
        // Currently under the selection point.
        private Usable usable = null;
        // Usable component of the current selection.
        private GameObject clickedDownOn = null;
        // Selection when the mouse button was pressed down.
